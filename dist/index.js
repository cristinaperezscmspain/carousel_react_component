...
/***/ function(module, exports, __webpack_require__) {
	...
	_react2['default'].render(_react2['default'].createElement(_src.Carousel, { data: data }), document.getElementById('main'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _suiCarousel = __webpack_require__(159);

	var _suiCarousel2 = _interopRequireDefault(_suiCarousel);

	exports['default'] = { Carousel: _suiCarousel2['default'] };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Slide = (function (_React$Component) {
	  ...
	  _createClass(Slide, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement('img', { height: this.props.imageHeight, alt: this.props.imageAlt, src: this.props.imagePath });
	    }
	  }]);
	...
	Slide.propTypes = {
	  imageHeight: _react2['default'].PropTypes.string.isRequired,
	  imageAlt: _react2['default'].PropTypes.string.isRequired,
	  imagePath: _react2['default'].PropTypes.string.isRequired
	};
	module.exports = exports['default'];
